        ...
        <div className="dash-in dash-d1 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <div>
                <h1 className="text-[22px] font-bold text-slate-50 tracking-tight">Command Center</h1>
                <p className="text-[13px] text-slate-300">Real-time governance intelligence overview</p>
              </div>
            </div>
          </div>

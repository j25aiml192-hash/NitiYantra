      ...
      <div className={`max-w-7xl mx-auto flex gap-6 items-start transition-all duration-700 ${extracted ? '' : 'justify-center'}`} style={{ transitionTimingFunction: 'cubic-bezier(0.22,1,0.36,1)' }}>
        ...
        <div className="bg-[var(--card)] rounded-2xl border border-[var(--border)] p-5 shadow-sm space-y-4">
          ...
          <div className="flex gap-3">
            <button className="flex-1 border border-dashed border-[var(--border)] rounded-xl p-3 text-sm text-[var(--text-muted)] hover:bg-indigo-500/10 hover:text-indigo-600 hover:border-indigo-300 transition-all cursor-pointer flex items-center justify-center gap-2">
              <FileText size={18} weight="duotone" /> Upload File (PDF, DOCX, TXT)
            </button>
            <button className="px-4 py-2 rounded-xl bg-gray-100 text-sm text-gray-600 hover:bg-gray-200 transition-all cursor-pointer flex items-center gap-2">
              <UploadSimple size={18} weight="bold" /> Upload
            </button>
          </div>
            ...
            <>
              ...
              <div className="space-y-2 pt-2 border-t border-[var(--border)]">
                ...
                <button
                  ...
                  className="w-full py-2 rounded-xl bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 shadow-sm shadow-indigo-500/20 transition-all flex items-center justify-center gap-2"
                >
                  <FileCsv size={18} weight="bold" /> Export to System
                </button>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button
                  onClick={handleClear}
                  className="px-3.5 py-2 rounded-xl text-xs font-medium text-[var(--text-muted)] hover:bg-red-50 hover:text-red-600 border border-[var(--border)] hover:border-red-200 transition-all flex items-center gap-2"
                >

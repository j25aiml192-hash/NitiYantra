          ...
          return (
            <>
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 text-[10px] font-semibold bg-[#ef4444] text-white rounded-full flex items-center justify-center shadow-sm">
